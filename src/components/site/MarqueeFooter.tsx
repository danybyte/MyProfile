  ...
  return (
    <footer className="overflow-hidden bg-card text-card-foreground">
      ...
      <div className="group relative py-16 md:py-24">
        <div className="flex w-max animate-[marquee_40s_linear_infinite] whitespace-nowrap group-hover:[animation-play-state:paused]">
          {track.map((w, i) => (
            <span
              key={i}
              className="pr-12 font-display text-[14vw] leading-none tracking-tight md:text-[10rem]"
            >
